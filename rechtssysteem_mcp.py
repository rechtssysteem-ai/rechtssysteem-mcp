...
TOOLS = [
    {"name": "voorspel_uitkomst",
     "description": ("Voorspelt de afloop van een Nederlandse rechtszaak uit "
                     ...
                     "er een fout terug. Kies deze tool als je een oordeel "
                     "over de afloop wilt; gebruik lekkage_check als je "
                     "alleen wilt meten of een tekst de uitkomst al "
                     "prijsgeeft, en rechtspraak_cijfers als het om de "
                     "benchmark-cijfers zelf gaat.\n"
    ...
    {"name": "rechtspraak_cijfers",
     "description": ("Geeft de benchmark-cijfers achter voorspel_uitkomst: "
                     ...
                     "om een cijfer te controleren voordat je het citeert — "
                     "niet om een zaak te beoordelen (dat is "
                     "voorspel_uitkomst) of een tekst te meten "
                     "(lekkage_check). De baseline hoort altijd naast de "
                     "accuracy: zonder die 43,7% zegt 78,2% niets.\n"
